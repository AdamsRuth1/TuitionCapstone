...
const Newsletter = () => {
  return (
    <div className="text-center lg:pb-[12.625rem] max-sm:pb-10 px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <div className=" lg:justify-center  lg:pt-[2rem] relative ">
        <span className="py-[10px] px-[27px]  absolute -ml-[1rem] -mt-[0.6rem] max-sm:hidden">
        ...
        <input
          ...
          className="lg:w-[608px]   h-[64px] font-Modarat
            font-normal text-[16px] text-[#A1A4A8] leading-[16px] max-sm:pr-10 max-sm:pl-7
            outline-none bg-[#F5F5F5] rounded-[4px] lg:pl-[3.8rem] border border-[#E6E6E6]"
        />
        <button
          className="py-[10px] max-sm:hidden sm:hidden lg:block px-[24px] rounded-[4px] bg-[#252E6A] text-[#FFFFFF] absolute -ml-[10rem] mt-[0.6rem]
            font-Modarat font-normal text-[16px] sm:text-[18px] md:text-[20px] leading-[20px] sm:leading-[22px] md:leading-[24px]"
        >
          Subscribe
        </button>
        <button
          className="py-[10px] lg:hidden px-[10px] rounded-[4px] bg-[#252E6A] text-[#FFFFFF] absolute -ml-[3.5rem] mt-[0.8rem]
            font-Modarat font-normal text-[16px] sm:text-[18px] md:text-[20px] leading-[20px] sm:leading-[22px] md:leading-[24px]"
        >
          Add
        </button>
