        ...
        <nav className="bg-white-400 py-2 shadow">
          <div className="flex items-center justify-between shadow-md py-2 ">
            ...
            <ul className="hidden md:flex space-x-4">
              ...
              <li>
                <a
                  href="#"
                  className="text-black hover:bg-white hover:text-blue-900 hover:border-blue-900 hover:rounded-full px-4 py-2 border-2 border-transparent transition-all duration-300"
                >
                  Developer
                </a>
              </li>
            ...
            <div className="md:flex justify-between space-x-4 mx-3 hidden">
              <button className="border-2 border-customButton rounded-md text-customButton py-1 px-3 hover:bg-customButton hover:text-white">
                Download App
              </button>
              <Link
                to="/signup"
          ...
          {isOpen ? (
            <ul className="flex-col md:hidden ">
              <li className=" text-black hover:text-white hover:bg-customButton hover:rounded-full px-3 py-3 border border-transparent transition-all duration-300">
                <a href="#" className="">
                  Home
                </a>
              </li>
              ...
              <div className=" flex flex-col justify-between mx-3 my-2">
                <button className="border-2 border-customButton rounded-md text-blue-800 py-1 w-full hover:bg-customButton hover:text-white">
                  Download App
                </button>
                <Link
                  to="/signup"
                  className="bg-blue-900 border rounded-md text-white py-2 w-full my-2 hover:bg-blue-900"
                >
                  Sign in
                </Link>
              </div>
