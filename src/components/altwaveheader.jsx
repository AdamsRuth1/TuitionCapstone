...
import Landing from './altwavelanding'
import Why from './altwavewhy'
import AltWaveExplore from './altwaveexplore'
...
<button className='bg-customButton border rounded-md text-white py-2 w-full my-2 hover:bg-blue-900'>Sign in</button>
