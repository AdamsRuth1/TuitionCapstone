...
<p className="text-customEnroll font-Modarat text-xl leading-8">With Tuition, no matter your location in the world, your students can easily pay their education fees without hassle <br/> <br/>
...
<div className="mb-6 ml-28 ">
    ...
    selected={selected}
    searchable
    onSelect={(code) => setSelected(code)} className="ml-28 text-gray-700 w-96 " 
  />
        </div>
